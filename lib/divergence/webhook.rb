    ...
    def handle_webhook
      ...
      if File.exists?(path)
        ...
        begin
          ...
          Application.log.info "Webhook: cloning ssh://hg@bitbucket.org#{payload['repository']['absolute_url']} to src"
          ...
          Application.log.error "Webhook: Failed to created project #{payload['repository']['slug']}"
        end
      end
